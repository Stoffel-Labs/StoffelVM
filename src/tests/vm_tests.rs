...
async fn test_basic_addition_program() {
    ...
    // Add r0, r1, r2
    let program = vec![
        ReducedOpcode::LoadImmediate as u8, 0, 5, 0, 0, 0, 0, 0, 0, 0,  // Load 5 into r0
        ReducedOpcode::LoadImmediate as u8, 1, 3, 0, 0, 0, 0, 0, 0, 0,  // Load 3 into r1
...
async fn test_function_call() {
    ...
    let function_code = vec![
        ReducedOpcode::LoadImmediate as u8, 1, 1, 0, 0, 0, 0, 0, 0, 0,  // Load 1 into r1
        ReducedOpcode::Add as u8, 0, 1, 0,  // Add r0 and r1, store in r0
        ReducedOpcode::Return as u8, 0,  // Return
    ];
